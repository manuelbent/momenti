...
class Container {
    ...
    private _rateLimitMiddleware?: RateLimitMiddleware
    // repositories
    ...
    public get rateLimitMiddleware(): RateLimitMiddleware {
        return this._rateLimitMiddleware ??= new RateLimitMiddleware()
    }
