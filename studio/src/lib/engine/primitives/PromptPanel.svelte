...
<div transition:fade={{ duration: 200 }}
    ...
    <div transition:scale={{ duration: 200, start: 0.96, easing: cubicOut }}
         class="bg-[#f0ede8] rounded-2xl p-5 w-[min(480px,80%)] shadow-[0_8px_40px_rgba(13,13,13,0.35)] flex flex-col gap-3">
        <textarea
                bind:this={textareaEl}
                class="w-full bg-transparent border-none outline-none resize-none font-serif text-sm leading-6 text-[#0d0d0d] caret-[#0d0d0d] placeholder-black/35"
